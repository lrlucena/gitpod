...
// // export function exec(command: string, callback: ExecOptions & { async: true }): child.ChildProcess;
// export function exec(cmd: string): shell.ShellString;
// export function exec(cmd: string, options: ExecOptions & { async: true }): Promise<ExecResult>;
// export function exec(cmd: string, options: { dontCheckRc: boolean }): shell.ShellString;
// export function exec(cmd: string, options?: ExecOptions): ChildProcess;
